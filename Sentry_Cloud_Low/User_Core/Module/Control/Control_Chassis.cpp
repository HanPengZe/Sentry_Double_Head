...
{
    /*--- 跟随模式 PID -----------------------------------------------------------------------*/
    Follow_PID[PID_Outer].SetPIDParam(6500.0f/* 6500.0f */, 0.0f, 0.0f, 2000, 6000/* 4500 */, 0.002f);//3200 5000
    Follow_PID[PID_Outer].I_SeparThresh = 1000;
		Follow_PID[PID_Inner].SetPIDParam(0.45f, 0.0f, 0.0f, 2000, 5500, 0.002f);  //0.45  0.1
...
int X_V = -40;
int Y_V = 40;
void Chassis_classdef::Radar_Control()
{
    Target_Vx = Vision.Radar_Recv_Msg.Pack.chassis_lx*X_V*100;
    Target_Vy = Vision.Radar_Recv_Msg.Pack.chassis_ly*Y_V*100;
 ...
 * @retval     None
 */
KFP Targer_Speed = {0.02,0,0,0,0.001,0.543};

float xy_jiasudu=2500;
void Chassis_classdef::Control()
{
    // SupCap Ctrl...
		if(Infantry.Chassis_Mode == CHAS_SentryPCMode)
		{
//	kalmanFilter(&Targer_Speed,&Vision.Radar_Recv_Msg.Pack.chassis_ly);
//	kalmanFilter(&Targer_Speed,&Vision.Radar_Recv_Msg.Pack.chassis_lx);
#if Open_Race ==1
			
//			  if(Infantry.my_output==0)
//        {
