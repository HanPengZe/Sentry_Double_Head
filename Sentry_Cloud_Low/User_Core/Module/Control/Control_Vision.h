...
#define VISION_Sentry_TX_SIZE    28
#pragma pack(1)
typedef struct  // 视觉的协议 接收一帧的数据结构体
{
...
#define VISION_Radar_RX_SIZE    10
#if SendRadar_Mode ==RMUC
#define VISION_Radar_TX_SIZE    14
#elif SendRadar_Mode == RMUL
#define VISION_Radar_TX_SIZE    7
#endif
#pragma pack(1)
typedef struct  // 视觉的协议 接收一帧的数据结构体
{
...
public:
	...
	Sentry_VisionRecvMsg_u Sentry_Send_Msg_usb; /*<! 从PC解包数据 */	

	Sentry_RadarSendMsg_u Radar_Send_Msg; /*<! 打包数据至PC */
	Sentry_RadarRecvMsg_u Radar_Recv_Msg; /*<! 从PC解包数据 */	

	void Sentry_SendToPC(Sentry_VisionSendMsg_Usb *pack2vision);
