...
#define GIMBAL_YAW_CENTRE	670    //下头 Yaw 中心点
#define GIMBAL_YAW_CENTRE_UP	7509    //上头 Yaw 中心点
#define GIMBAL_YAW_RECENTRE 7345	// Yaw 反向中心点

// 顶部与底部的相应数值根据电机的安装方式而定-------------*/
#define GIMBAL_PIT_MIN		1370	// Pit 编码限位最大值 
#define GIMBAL_PIT_MAX		2370	// Pit 编码限位最小值
...
public:
	...
	Motor_GM6020 Motor[2] = {Motor_GM6020(6), Motor_GM6020(5)};
