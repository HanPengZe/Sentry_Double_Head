...
#define GIMBAL_YAW_CENTRE	1434    	// Yaw 中心点
#define GIMBAL_YAW_RECENTRE 2692	// Yaw 反向中心点
//3,438 7,534
// 顶部与底部的相应数值根据电机的安装方式而定-------------*/
#define GIMBAL_PIT_MIN		3700	 	 // Pit 编码仰角限位 
#define GIMBAL_PIT_MAX		4400  	 // Pit 编码俯角限位
#define GIMBAL_PIT_CENTRE 4000	
...
public:
	...
	Motor_GM6020 Motor_Yaw[2] = {Motor_GM6020(5),Motor_GM6020(6)};
	PositionPID YawPID[6][3];  /*<! 云台电机各模式PID */
	...
	float Target_Pit;
	float TargetAngle[2];
	float 	Armor_ID[4]={978,3000,5379,7403};
